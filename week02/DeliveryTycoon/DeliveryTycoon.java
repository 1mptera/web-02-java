...
public class DeliveryTycoon {
    public static void main(String[] args) {
        ...
        if (money <= 5000 && money > 2000 && popularity <= 50 && popularity > 20) {
            currentLevel = storeName[1];
        }
        if (money <= 8000 && money > 5000 && popularity <= 80 && popularity > 500) {
        ...
        while (true) {
            ...
            if (choose == 1) {
                for (int i = 0; i < 5; i += 1) {
                    ...
                    System.out.println("체력: " + hp + ", 자산: " + money + "만원, 인지도: " + popularity);
                    System.out.println("--------------------------------------------");
                    System.out.println("6개의 주문이 들어 왔습니다. (10초 안에 음식을 완성해주세요.)");

                    int randomFood = random.nextInt(6);
                    for (int j = 0; j <= randomFood; j += 1) {
            ...
            while (choose != 4) {
                if (choose == 2) {
                    ...
                    if (choose == 3) {
                        ...
                        if (succes) {
                            money *= 2;
                            System.out.println("복권 성공! 내 자산: " + money);
                        }
                        if (!succes) {
                            System.out.println("복권 실패! 내 자산: " + money);
                        }
                        continue;
                    }
                }
