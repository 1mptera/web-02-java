...
public class LaunchWorldCup {
    public static void main(String[] args) {
        ...
        if (option == 2) {
            ...
            int option1a = scanner.nextInt();

            System.out.println("1. 우동 vs 2. 돈까스");

            int option2a = scanner.nextInt();

            if (option1a == 1 && option2a == 1) {
                System.out.println("1. 스시 vs 2. 우동");
                int result1a = scanner.nextInt();
            ...
            if (option1a == 1 && option2a == 2) {
                System.out.println("1. 스시 vs 2. 돈까스");
                int result2a = scanner.nextInt();
            ...
            if (option1a == 2 && option2a == 1) {
                System.out.println("1. 덴뿌라 vs 2. 우동");
                int result3a = scanner.nextInt();
            ...
            if (option1a == 2 && option2a == 2) {
                System.out.println("1. 덴뿌라 vs 2. 돈까스");
                int result4a = scanner.nextInt();
        ...
        if (option == 4) {
            ...
            int option1b = scanner.nextInt();

            System.out.println("1. 스테이크 vs 2. 피자");

            int option2b = scanner.nextInt();

            if (option1b == 1 && option2b == 1) {
                System.out.println("1. 파스타 vs 2. 스테이크");
                int result1b = scanner.nextInt();
            ...
            if (option1b == 1 && option2b == 2) {
                System.out.println("1. 파스타 vs 2. 파자");
                int result2b = scanner.nextInt();
            ...
            if (option1b == 2 && option2b == 1) {
                System.out.println("1. 리조또 vs 2. 스테이크");
                int result3b = scanner.nextInt();
            ...
            if (option1b == 2 && option2b == 2) {
                System.out.println("1. 리조또 vs 2. 파자");
                int result4b = scanner.nextInt();
