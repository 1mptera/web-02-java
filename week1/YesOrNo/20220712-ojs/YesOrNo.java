...
public class YesOrNo {
    public static void main(String[] args) {
        ...
        boolean results3 = answer3 == 1;
        if (answer2 ==2 && answer3 == 2) {
            System.out.println("함께 공부하는 동료들이 에러 해결 방법을 알고 있다.\n1. Yes \n2. No");
        }
        if ((results2) || (answer2 == 2 && results3)) {
            System.out.println("이제 스스로 더 고민해보면서 문제를 해결해 보세요!\n1. Yes \n2. No");
            return;
        }
        if ((answer2 != 1 && answer2 != 2) || (answer3 != 1 && answer3 != 2)) {
            System.out.println("잘못된 입력입니다. 프로그램이 종료됩니다.\n1. Yes \n2. No");
            return;
        }
        ...
        boolean results4 = answer4 == 1;


        if ((results2) || (answer2 == 2 && results3) || (answer2 == 2 && answer3 == 2 && results4)) {
            System.out.println("이제 스스로 더 고민해보면서 문제를 해결해 보세요!\n1. Yes \n2. No");
            return;
        }
        if (answer2 == 2 && answer3 == 2 && answer4 == 2) {
            System.out.println("트레이너에게 DM을 보내 질문하세요.\n1. Yes \n2. No");
            return;
        }
        if ((answer2 != 1 && answer2 != 2) || (answer3 != 1 && answer3 != 2) || (answer4 != 1 && answer4 != 2)) {
            System.out.println("잘못된 입력입니다. 프로그램이 종료됩니다.\n1. Yes \n2. No");
            return;
